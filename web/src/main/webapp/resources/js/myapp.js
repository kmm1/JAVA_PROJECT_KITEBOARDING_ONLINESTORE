...
// -------------------------
    ...
    $('button[name="refreshCart"]').click(function() {
        ...
        var producrtId = $(this).attr('value');
        var countElement = $('#count_' + producrtId);
        ...
        if(currentCount !== originalCount) {
            if(currentCount < 1 ) {
                ...
                bootbox.alert({
                    size: 'medium',
                    title: 'Error',
                    message: 'Product count should be minimum!'
                });
            }
            else {
                var updateUrl = window.contextRoot + '/cart/' + producrtId + '/update?count=' + currentCount;
