 ...
 */
@Component
public final class TestDataImporterImpl2 implements TestDataImporter2 {
    ...
    public void importTestData() {
        ...
        saveOrder(session, user1, new ArrayList(Arrays.asList(kite50Fifty, kite50Fifty, kiteboardTrideNBL)), LocalDateTime.of(LocalDate.of(2018, Month.JANUARY, 01), LocalTime.NOON), EnumOrderStatus.PAID);
